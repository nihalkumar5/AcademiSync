          ...
          <div className="flex flex-col mt-0.5 min-w-0 flex-1">
            ...
            <p className="text-[13px] text-[#6F6F6F] mt-2.5 leading-snug max-w-md truncate">
              {programme || branch ? (
                ...
                <span className="text-[#888888]">Set up your academic details below</span>
              )}
            </p>
              ...
              <div className="flex items-center justify-end gap-2 mt-2">
                ...
                <button 
                  onClick={async () => {
                    ...
                    await disconnectBatchTimetable();
                  }}
                  className="px-4 py-2 bg-red-600 text-white text-[12px] font-bold uppercase tracking-wider hover:bg-red-700 transition-colors cursor-pointer"
                >
                  Confirm & Leave
                </button>
              </div>
