    ...
    <>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 items-stretch font-sans text-left">
          ...
          <div className="md:col-span-5 flex flex-col items-center justify-center bg-[#F9F9F8] dark:bg-[#121317] border border-[#E5E5E5] dark:border-white/[0.08] rounded-none p-4 sm:p-5 text-center relative overflow-hidden">
            <div className="w-full flex items-center justify-center relative">
              <img 
                src="/cr.png" 
                alt="Batch Pilot" 
                className="w-full max-w-[320px] sm:max-w-[280px] h-auto object-contain drop-shadow-sm scale-105 transform origin-top"
              />
            </div>
            
            <div className="flex flex-col gap-1 -mt-10 sm:-mt-12 z-10 relative px-3 py-2 bg-[#F9F9F8]/85 dark:bg-[#121317]/85 backdrop-blur-sm">
