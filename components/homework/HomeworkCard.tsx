...
export const HomeworkCard: React.FC<HomeworkCardProps> = ({
  ...
  if (diffDays === 0) {
    ...
    deadlineLabel = `${Math.abs(diffDays)}d overdue`;
  } else {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col">
        {/* Number and Top-Right Action Toolbar */}
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5 self-start">
            ...
            <button
              ...
              className="p-1 text-[#A0A0A0] hover:text-[#C94B5C] hover:bg-black/5 dark:hover:bg-white/10 rounded transition-colors cursor-pointer"
              title="Delete Task"
            ...
            <div className="relative shrink-0" ref={dropdownRef}>
              <button
                ...
                className="p-1 text-[#A0A0A0] hover:text-[#151515] dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/10 rounded transition-colors cursor-pointer"
                ...
                {showMenu && (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="flex items-center gap-3 px-4 py-2.5 text-[12px] font-semibold text-left text-[#C94B5C] hover:bg-rose-50 dark:hover:bg-rose-950/40 transition-colors w-full cursor-pointer border-t border-black/[0.06] dark:border-white/[0.08]"
                    >
                      <Trash2 className="w-3.5 h-3.5" />
                      Delete Task
                    </button>
        ...
        <div className="flex items-start gap-3 mt-2.5">
          ...
          >
            <h4 className={clsx(
              ...
              isDone ? "text-[#737373] dark:text-[#64748B] line-through" : "text-[#151515] dark:text-[#F4F4F6]"
            )}>
              {homework.title}
            </h4>
            {homework.description && (
              <p className="text-[13px] text-[#737373] dark:text-[#94A3B8] mt-1 line-clamp-2 leading-relaxed">
                {homework.description}
              </p>
            )}
          </div>
