                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <input
                          ...
                          className="w-full px-3 py-1.5 h-[38px] rounded-none bg-white dark:bg-[#090A0C] border border-black/10 dark:border-white/[0.1] text-[13px] text-black dark:text-[#F4F4F6] focus:outline-none focus:border-black dark:focus:border-white/30 transition-colors placeholder:text-black/30 dark:placeholder:text-[#64748B]"
                        />
                      </div>
                    </div>
                  </div>
