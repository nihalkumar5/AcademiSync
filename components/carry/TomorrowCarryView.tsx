...
export const TomorrowCarryView: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-6 text-left max-w-4xl mx-auto w-full pb-12 font-sans">
      {/* Editorial Stacked Header — exactly matching Weekly Timetable & Tasks */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col gap-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[11px] font-mono font-bold border border-black dark:border-white text-black dark:text-white px-2 py-0.5 rounded-none">
            ...
            {targetClasses.length === 0 ? (
              ...
              targetClasses.map((sess) => {
                ...
                return (
                  <div
                    key={sess.id}
                    className="p-3.5 glass-card border border-black dark:border-white rounded-none flex items-center justify-between text-left"
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="flex flex-col min-w-0">
                        ...
                        <span className="text-[11px] text-black/50 dark:text-white/50 flex items-center gap-1 font-medium truncate mt-0.5">
        ...
        <div className="lg:col-span-7 flex flex-col gap-3">
          <div className="glass-card border border-black dark:border-white rounded-none flex flex-col gap-4 p-5">
