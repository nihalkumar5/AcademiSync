  ...
  if (todayHoliday) {
    return (
      <div className="flex flex-col gap-3 text-left">
        ...
        <div className="glass-card p-6 text-left flex flex-col gap-2 relative overflow-hidden border border-black dark:border-white bg-neutral-50 dark:bg-neutral-900/30">
