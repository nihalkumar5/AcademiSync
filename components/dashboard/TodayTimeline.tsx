  ...
  if (todayHoliday) {
    return (
      <div className="flex flex-col gap-3 text-left">
        ...
        <div className="glass-card p-6 text-left flex flex-col gap-2 relative overflow-hidden border border-black dark:border-white !bg-yellow-50 dark:!bg-yellow-900/20">
