...
export const LiveClassCard: React.FC = () => {
  ...
  if (todayHoliday) {
    return (
      <div className="glass-card p-5 sm:p-6 text-left relative overflow-hidden border border-black/10 dark:border-white/10 bg-yellow-100 dark:bg-yellow-900/30">
