...
async function createBalancedSplash() {
  const size = 1152;
  ...
  // 1. Icon (440px - perfectly balanced sweet spot)
  const iconSize = 440;
  ...
  // 2. Text (fontSize 64px - total width ~520px, well within circle safe zone)
  const fontSize = 64;
  const textY = iconY + iconSize + 65;
  ...
  console.log('Saved balanced ic_splash_logo.png');
...
createBalancedSplash().catch(console.error);
