...
async function createBigSplash() {
  const size = 1152;
  ...
  // 1. Icon (560px - significantly larger and bolder)
  const iconSize = 560;
  ...
  // 2. Text (fontSize 88px - bold, prominent and crisp)
  const fontSize = 88;
  const textY = iconY + iconSize + 90;
  ...
  console.log('Saved large ic_splash_logo.png');

  // Full screen splash for all densities
  ...
  console.log('All drawables updated with scaled-up large splash!');
}

createBigSplash().catch(console.error);
