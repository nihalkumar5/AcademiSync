...
import { ArrowRight, Calendar, Bell, Users, ArrowLeft, Search, Link2, Sparkles, ChevronRight, School, X } from 'lucide-react';
                ...
                >
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      className="w-full h-10 px-3.5 bg-white border border-[#D9D9D6] rounded-xl text-[13px] text-[#111111] focus:outline-none focus:border-[#111111]"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="flex flex-col gap-1">
                      ...
                      <select
                        ...
                        className="w-full h-10 px-3 bg-white border border-[#D9D9D6] rounded-xl text-[13px] text-[#111111] focus:outline-none focus:border-[#111111]"
                      >
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    {branch === 'Other / General' && (
                      <input
                        ...
                        className="mt-1.5 w-full h-10 px-3.5 bg-white border border-[#D9D9D6] rounded-xl text-[13px] text-[#111111]"
                        required
                      />
                    )}
                  </div>
...
with open('components/onboarding/OnboardingModal.tsx', 'w') as f:
    f.write(code)
print('Successfully written perfected OnboardingModal.tsx')
