signin_code = """import { SignIn } from "@clerk/nextjs";
...
signup_code = """import { SignUp } from "@clerk/nextjs";
...
with open('app/sign-in/[[...sign-in]]/page.tsx', 'w') as f:
    f.write(signin_code)

with open('app/sign-up/[[...sign-up]]/page.tsx', 'w') as f:
    f.write(signup_code)

print('Updated sign-in and sign-up pages successfully!')
